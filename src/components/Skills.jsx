...
export default function Skills(){
    ...
    return(
        <div>
            ...
            {/*I HAVE TO FIGURE OUT HOW TO HAVE A SMOOTH TRASLATION OF THE SIBLINGS*/}
            <div className={`transition-all delay-150 ease-in-out duration-300 ${hidden ? " max-h-0 opacity-0 -translate-y-[20px]" : "max-h-[500px] opacity-1 translate-y-0"}`}> 
