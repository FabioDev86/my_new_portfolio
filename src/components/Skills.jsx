...
export default function Skills(){
    ...
    return(
        <div className="z-10">
            ...
            <div className={`grid md:grid-cols-3 lg:grid-cols-4 transition-all delay-150 ease-in-out duration-300 ${hidden ? " max-h-0 opacity-1 scale-0 -translate-y-[20px]" : "max-h-[800px] opacity-100 scale-100 translate-y-0"}`}> 
                <div className="flex justify-between px-10 items-center mb-7">
                    <p className="frontend">Front End</p>
                    <p className="backend">Back End</p>
                    <p className="utility">Utility</p>
                </div>
